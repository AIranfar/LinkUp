...
def seed_users():
    ...
    elon = User(
        ...
        first_name='Elon',
        last_name='Musk',
        profile_image='https://ichef.bbci.co.uk/news/640/cpsprodpb/7727/production/_103330503_musk3.jpg',
        about_me='Visionary entrepreneur driven by a passion for innovation and a relentless pursuit of breakthroughs. From co-founding PayPal to revolutionizing electric vehicles with Tesla, I\'m constantly pushing boundaries. SpaceX, my space exploration company, aims to make humanity a multi-planetary species. Neuralink seeks to merge humans with artificial intelligence for cognitive enhancement. With a desire to combat climate change, I founded SolarCity and work on developing sustainable energy solutions. My mission is to change the world, one groundbreaking idea at a time.',
    ...
    tim = User(
        ...
        first_name='Tim',
        last_name='Cook',
        profile_image='https://media.idownloadblog.com/wp-content/uploads/2018/02/Tim-Cook.jpg',
        about_me='A purpose-driven leader at the helm of Apple. With a focus on sustainability and ethical practices, I\'ve championed environmental initiatives and transformed Apple into a green company. Guided by my values of inclusivity and privacy, I\'ve strengthened user data protection and advocated for LGBTQ+ rights. My dedication to innovation led to the launch of groundbreaking products like the iPhone X and Apple Watch. I believe in the power of technology to empower individuals and improve lives. Through philanthropy, I strive to create positive change and inspire others to do the same.',
